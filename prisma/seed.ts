...
async function main() {
  ...
  if (articleCount === 0) {
    const articles = [
      ...
      { title: "Barriers and Opportunities for Astronomy Education in Secondary Schools across Nepal: A Survey of 320 Students and 45 Teachers", authors: JSON.stringify(["S. Bajracharya", "A. Sharma", "L. Gurung"]), ekaAuthors: JSON.stringify(["S. Bajracharya", "A. Sharma"]), journal: "arXiv (Education)", year: 2022, date: "2022-11-07", type: "preprint", disciplines: JSON.stringify(["Science Education"]), abstract: "We surveyed 320 students and 45 physics teachers across five provinces to assess the state of astronomy education in Nepali secondary schools. Identified barriers include limited access to equipment, no dedicated astronomy curriculum, and a lack of trained educators.", imageUrl: "https://images.unsplash.com/photo-1503676260728-1c00da094a0b?auto=format&fit=crop&w=800&q=80", arxiv: "2211.03847", featured: false, published: true },
