...
const LEVELS = [
  "Class 9–12 student", "Bachelor's student", "Master's student",
        ...
        <div className={styles.leftInner}>
          ...
          <div className={styles.leftContent}>
            ...
            <p className={styles.leftSub}>
              Free to join. Open to everyone from Class&nbsp;9 to PhD. No applications, no prerequisites.
            </p>
